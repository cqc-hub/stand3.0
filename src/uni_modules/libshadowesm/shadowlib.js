...
var AR_SHADOW_GetRandom = function() {
  for (var r = "", a = "abcdefghijkllmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", t = 0; t < 8; t++)
    r += a.charAt(parseInt(63 * Math.random(), 10));
  return r;
}, AR_SHADOW_Base64Url = function(r) {
  var a = "";
  return r && (a = r.replace(/\+/g, "-").replace(/\//g, "_")), a;
}, AR_SHADOW_DoEncrypt = function(r, a) {
  var t = new uni_modules_libshadowesm_shadowen.JSEncrypt();
  if (t.setPublicKey(a), r)
    return AR_SHADOW_Base64Url(t.encrypt(r));
};
function ar_shadow_desbase(r, a, t) {
  var e, o, _, n, d, s, i;
  return e = AR_SHADOW_GetRandom(), o = AR_SHADOW_CryptoJS.enc.Utf8.parse(e), _ = AR_SHADOW_CryptoJS.DES.encrypt(r, o, { mode: AR_SHADOW_CryptoJS.mode.ECB, padding: AR_SHADOW_CryptoJS.pad.Pkcs7 }), d = (n = AR_SHADOW_Base64Url(_.toString())).length, i = (uni_modules_libshadowesm_crc32c.AR_SHADOW_CRC32.str(n) >>> 0).toString().padStart(16, "0"), s = AR_SHADOW_DoEncrypt(e + d + "|" + i + "|", a), 1 == t ? encodeURIComponent(s + n) : s + n;
}
function ar_shadow_isurlnotinarray(r, a) {
  return !(a.indexOf(r) > -1);
}
function ar_shadow_addparametertourl(r, a, t, e) {
  var _ = ar_shadow_isurlnotinarray(r, uni_modules_libshadowesm_config.ar_shadow_noxhrurls.split(","));
  if (_) {
    if (r += (r.split("?")[1] ? "&" : "?") + "arshadowurlqueryparamid=" + ar_shadow_desbase(t, e, 1), a && "object" == typeof a) {
      return { requrl: r, reqbody: Object.fromEntries(Object.entries(a).map(([r2, a2]) => {
        ar_shadow_desbase(r2, e, 0);
        let t2 = a2;
        return "string" == typeof a2 && (t2 = "shadowanruiform" + ar_shadow_desbase(a2, e, 0)), [r2, t2];
      })) };
    }
    return { requrl: r };
  }
...
const shadowlib = {
  ar_shadow_addparametertourl,
  ar_shadow_initPub,
  ar_shadow_getrandom: AR_SHADOW_GetRandom
};

// 将 CommonJS exports 转换为 ES6 export
export { shadowlib };
