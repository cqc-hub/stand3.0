      ...
      <view class="scroll-content" :style="[scrollContentStyle]">
        ...
        <view class="empty-wrap" v-if="showEmpty">
          ...
          <view class="empty-view" v-else>
            <view>
              <g-empty :current="1" :text="emptyText" noTransformY />
            </view>
          </view>
        </view>
        ...
        <view class="pull-up-wrap" v-if="showPullUp">
          ...
          <view class="load-view" v-else>
            ...
            ></view>
            <!-- :style="[pullUpTextStyle]" -->
            <text class="pull-up-text">
              {{ loadStateText }}
            </text>
          </view>
        </view>
  ...
  export default {
    ...
    methods: {
      ...
      listContentObserve() {
        ...
        const listContentObserve = uni.createIntersectionObserver(this, {
          thresholds: [0, 0.5, 1],
        });
      ...
      scrollViewObserve() {
        ...
        this.$nextTick(() => {
          this.queryRect('.' + this.elClass).then((rect) => {
            const scrollViewObserve = uni.createIntersectionObserver(this, {
              thresholds: [0, 0.5, 1],
            });
        ...
        .pull-up-wrap {
          ...
          .load-view {
            ...
            .pull-up-text {
              ...
              color: var(--hr-neutral-color-5) !important;
